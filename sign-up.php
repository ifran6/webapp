        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="uni__card-container">
                    ...
                    <form action="" class="sgn-up-form" method="post">
                        <h3 class="text-center">Sign-up</h3>
                        <div class="form-group">
                            <label for="username">
                                <strong>Names</strong>
                                <input type="text" placeholder="Enter Name" name="username"
                                    class="form-control-lg s-username input-elem">
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="email-ID">
                                ...
                                <input type="text" placeholder="Enter Email-ID" name="email"
                                    class="form-control-lg s-email input-elem">
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="Password">
                                ...
                                <input type="password" placeholder="Enter Password" name="password"
                                    class="form-control-lg s-password input-elem">
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="confirm-Password">
                                ...
                                <input type="password" placeholder="Confirm Password" name="confirm-password"
                                    class="form-control-lg s-confirm-password input-elem">
                            </label>
                        </div>
